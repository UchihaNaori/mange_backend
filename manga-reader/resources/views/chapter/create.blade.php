                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" id="create-chapter" action="{{ route('chapter.create', $comicId) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="col-10">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputFile">Content chapter</label>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="{{ "/chapter/listChapter?comicId=".$comicId }}"><button type="button" class="btn btn-default float-right">Cancel</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
...
@section('js')
    ...
    <script src="{{ asset('js/validation_form/chapter/create.js') }}"></script>
@stop
